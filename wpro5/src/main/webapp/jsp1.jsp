...
String irum = "송여빈"; // service 메소드 내에 선언된 지역변수
System.out.println(irum); // 서버 컴의 콘솔로 출력(개발자가 뭔가 출력하고자 할 때 사용)
// PrintWriter 객체 타입의 내장객체중 하나 
out.println(irum + "님의 홈페이지임을 선언하노라!"); // 클라이언트 브라우저로 출력 
%>
<br>
<!-- expression(표현식), 출력문 1개만 적음, 출력문 뒤에 ;은 적지 않음 -->
<%= irum + "님의 홈페이지임을 선언하노라!" %> 
<br>
<h1>자바 만세</h1>
<h2>자바 만세</h2>
<h3>자바 만세</h3>
