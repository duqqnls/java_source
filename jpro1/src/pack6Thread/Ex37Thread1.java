...
public class Ex37Thread1 extends Thread{ //thread는 java.lang패키지 안에 있고, import 안 해도 됌 ㅎㅎ 
	public Ex37Thread1() {

	}
	
	public Ex37Thread1(String name) {
		super(name); //super는 thread 다 
	}
	
	public void run() { //thread를 상속받아 run를 사용함 - 쓰레드 사용 
		for(int i = 1; i <= 50; i++) {
	...
	public static void main(String[] args) {
		...
		// 응용 프로그램의 실행은 thread(실행 단위)가 한다
		...
		try {
			...
			/* 1.
			Thread를 사용하지 않은 경우 : 순차적으로 실행 예)th1를 찍고 th2를 찍음
			...
			*/
			...
			/* 2.
			사용자 Thread를 사용한 경우 : 랜덤하게 실행
			*/
//			Ex37Thread1 th1 = new Ex37Thread1();
			Ex37Thread1 th1 = new Ex37Thread1("one");
			th1.start(); // start가 run()을 실행 
//			Ex37Thread1 th2 = new Ex37Thread1();
