...
// 상세보기 하면 조회수 증가
boardMgr.updateReadcnt(num); // String으로 넘어간다.
...
String adminPass = "*****"; // 로그인 하지 않으면 비밀번호 안 보이기

//회원가입 후 로그인에 성공하면 세션 생성한다고 가정하고 세션 읽기
String adminOk = (String)session.getAttribute("adminOk"); 
if(adminOk != null) {
	if(adminOk.equalsIgnoreCase("yeobin")) adminPass = pass; 
	
	// 세션이 없으면 *을 갖고 세션이 있으면 비밀번호를 가진다.
...
<table>
	<tr>
		<td><b>비밀번호 : <%=adminPass %></b></td> <!-- *이 찍힌다. -->
	...
	<tr>
		<td colspan="3" style="background-color: pink">제목 : <%=title %></td>
	</tr>
	<tr>
		<td colspan="3">
