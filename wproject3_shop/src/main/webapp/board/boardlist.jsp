	...
	<tr>
		<td>
			...
			<table style="width: 100%;">
				...
				// ArrayList<BoardDto> list = boardMgr.getDataAll(spage);  			 // 페이지처리만 진행
				ArrayList<BoardDto> list = boardMgr.getDataAll(spage, stype, sword); // 페이지, 검색 처리   
			...
			<table style="width: 100%">
				<tr>
					...
					for(int i = 1; i <= pageSu; i++){
						if(i == spage) {
							out.print("<b style='font-size:12pt; color:pink'>[" + i + "]</b>");	
						}else{
