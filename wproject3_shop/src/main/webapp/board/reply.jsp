...
<input type="hidden" name="nested" value="<%=dto.getNested() %>" > 
	<table border="1">
		...
		<tr>
			...
			<td><input type="password" name="pass" style="width:98%" size="15"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="title" style="width:98%" value="[Re]:<%=dto.getTitle()%>"></td>
		</tr> 
		<tr>
			<td align="center">내 용</td>
			<td><textarea name="cont" rows="10" style="width:98%"></textarea></td>
		</tr>
		<tr>
