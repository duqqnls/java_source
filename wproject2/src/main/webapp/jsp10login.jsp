...
if (id != null && password != null &&
	...
	// 위의 작업(22-25라인)을 주석 처리하고 아래 내용으로 변경하자.
	...
	// 만료시간
	long expirationTime = 360000; // 1시간 (밀리초)
	
	// JWT 생성 : 문자열로 반환되며, 인증 및 권한부여 메커니즘에서 주로 사용
	String jwt = Jwts.builder()
					.setSubject(id) 													  // id, 사용자 식별자, 주제등이 포함된 Claim 설정
					.setIssuedAt(new Date())											  // 클레임 내용 중 lat : 발행 시간 
					.setExpiration(new Date(System.currentTimeMillis() + expirationTime)) // 클레임 내용 중 exp : 만료 시간 
